          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-white/90">
            <div className="flex items-center">
              ...
              <div>
                ...
                <div className="font-mono">{formatTemperature(data.main.feels_like, unit)}</div>
              </div>
            </div>
            <div className="flex items-center">
              ...
              <div>
                ...
                <div className="font-mono">{data.main.humidity}%</div>
              </div>
            </div>
            <div className="flex items-center">
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-neutral-100 p-4 rounded-lg">
            ...
            <div className="text-lg font-mono">{data.main.pressure} hPa</div>
          </div>
          <div className="bg-neutral-100 p-4 rounded-lg">
